...
def parse_args():
    ...
    parser.add_argument('--yes', '--accept-tos', action='store_true',
                        help='Skip the interactive terms-of-use confirmation '
...
def download_file(url, out_file, report_progress=False):
    ...
    for attempt in range(1, DOWNLOAD_RETRIES + 1):
        ...
        try:
            ...
            return
        except (URLError, HTTPError, TimeoutError, ConnectionResetError, OSError) as exc:
            try:
                os.remove(out_file_tmp)
            except OSError:
                pass
            tqdm.write(
                'WARNING: failed to download {} (attempt {}/{}): {}'.format(
...
def main(args):
    ...
    if not args.yes:
        ...
        print('Skipping TOS confirmation because --yes was provided.')
